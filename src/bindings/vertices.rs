...
use super::{Context, Error, LibISLError};
use libc::uintptr_t;
...
impl Vertices {
    ...
    pub fn free(self) -> Result<Vertices, LibISLError> {
        let vertices = self;
        let isl_rs_ctx = vertices.get_ctx();
    ...
    pub fn get_n_vertices(&self) -> Result<i32, LibISLError> {
        let vertices = self;
        let isl_rs_ctx = vertices.get_ctx();
        let vertices = vertices.ptr;
