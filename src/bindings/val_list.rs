...
use super::{Context, Error, LibISLError, Val};
use libc::uintptr_t;
...
impl ValList {
    ...
    pub fn add(self, el: Val) -> Result<ValList, LibISLError> {
        let list = self;
    ...
    pub fn alloc(ctx: &Context, n: i32) -> Result<ValList, LibISLError> {
    ...
    pub fn concat(self, list2: ValList) -> Result<ValList, LibISLError> {
        let list1 = self;
    ...
    pub fn drop(self, first: u32, n: u32) -> Result<ValList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn from_val(el: Val) -> Result<ValList, LibISLError> {
    ...
    pub fn get_at(&self, index: i32) -> Result<Val, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn get_val(&self, index: i32) -> Result<Val, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    /// Does not call isl_val_list_free() on being dropped. (For internal use
    /// only.)
