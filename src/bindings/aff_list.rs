...
use super::{Aff, Context, Error, LibISLError};
use libc::uintptr_t;
...
impl AffList {
    ...
    pub fn add(self, el: Aff) -> Result<AffList, LibISLError> {
        let list = self;
    ...
    pub fn alloc(ctx: &Context, n: i32) -> Result<AffList, LibISLError> {
    ...
    pub fn concat(self, list2: AffList) -> Result<AffList, LibISLError> {
        let list1 = self;
    ...
    pub fn drop(self, first: u32, n: u32) -> Result<AffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn from_aff(el: Aff) -> Result<AffList, LibISLError> {
    ...
    pub fn get_aff(&self, index: i32) -> Result<Aff, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn get_at(&self, index: i32) -> Result<Aff, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn set_at(self, index: i32, el: Aff) -> Result<AffList, LibISLError> {
        ...
        el.do_not_free_on_drop();
        let el = el.ptr;
        let isl_rs_result = unsafe { isl_aff_list_set_at(list, index, el) };
        let isl_rs_result = AffList { ptr: isl_rs_result,
                                      should_free_on_drop: true };
        let err = isl_rs_ctx.last_error();
        if err != Error::None_ {
    ...
    /// Does not call isl_aff_list_free() on being dropped. (For internal use
    /// only.)
