...
use super::{Context, Error, LibISLError, QPolynomial};
use libc::uintptr_t;
use std::ffi::CStr;
...
impl QPolynomialList {
    ...
    pub fn set_qpolynomial(self, index: i32, el: QPolynomial)
    ...
    /// Does not call isl_qpolynomial_list_free() on being dropped. (For
    /// internal use only.)
