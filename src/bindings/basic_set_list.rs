...
impl BasicSetList {
    ...
    pub fn add(self, el: BasicSet) -> Result<BasicSetList, LibISLError> {
        let list = self;
    ...
    pub fn alloc(ctx: &Context, n: i32) -> Result<BasicSetList, LibISLError> {
    ...
    pub fn clear(self) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn coefficients(self) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn concat(self, list2: BasicSetList) -> Result<BasicSetList, LibISLError> {
        let list1 = self;
    ...
    pub fn copy(&self) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn drop(self, first: u32, n: u32) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn free(self) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn from_basic_set(el: BasicSet) -> Result<BasicSetList, LibISLError> {
    ...
    pub fn get_at(&self, index: i32) -> Result<BasicSet, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn get_basic_set(&self, index: i32) -> Result<BasicSet, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn insert(self, pos: u32, el: BasicSet) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn intersect(self) -> Result<BasicSet, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn reverse(self) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn set_at(self, index: i32, el: BasicSet) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn set_basic_set(self, index: i32, el: BasicSet) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn swap(self, pos1: u32, pos2: u32) -> Result<BasicSetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
