...
use super::{Context, Error, LibISLError, PwQPolynomialFold};
use libc::uintptr_t;
use std::ffi::CStr;
...
impl PwQPolynomialFoldList {
    ...
    pub fn add(self, el: PwQPolynomialFold) -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
    ...
    pub fn alloc(ctx: &Context, n: i32) -> Result<PwQPolynomialFoldList, LibISLError> {
    ...
    pub fn clear(self) -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn concat(self, list2: PwQPolynomialFoldList)
    ...
    pub fn copy(&self) -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn drop(self, first: u32, n: u32) -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn free(self) -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn from_pw_qpolynomial_fold(el: PwQPolynomialFold)
                                    -> Result<PwQPolynomialFoldList, LibISLError> {
    ...
    pub fn get_at(&self, index: i32) -> Result<PwQPolynomialFold, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn get_pw_qpolynomial_fold(&self, index: i32) -> Result<PwQPolynomialFold, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
        let isl_rs_result =
    ...
    pub fn insert(self, pos: u32, el: PwQPolynomialFold)
                  -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
    ...
    pub fn reverse(self) -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn set_at(self, index: i32, el: PwQPolynomialFold)
                  -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
    ...
    pub fn swap(self, pos1: u32, pos2: u32) -> Result<PwQPolynomialFoldList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
