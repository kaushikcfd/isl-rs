...
impl Val {
    ...
    pub fn list_add(list: ValList, el: Val) -> ValList {
        let mut list = list;
    ...
    pub fn list_copy(list: &ValList) -> ValList {
        let list = list.ptr;
    ...
    pub fn list_drop(list: ValList, first: u32, n: u32) -> ValList {
        let mut list = list;
        list.do_not_free_on_drop();
        let list = list.ptr;
    ...
    pub fn list_free(list: ValList) -> ValList {
        let mut list = list;
        list.do_not_free_on_drop();
        let list = list.ptr;
    ...
    pub fn list_insert(list: ValList, pos: u32, el: Val) -> ValList {
        let mut list = list;
        list.do_not_free_on_drop();
        let list = list.ptr;
        let mut el = el;
    ...
    pub fn list_set_at(list: ValList, index: i32, el: Val) -> ValList {
        let mut list = list;
        list.do_not_free_on_drop();
        let list = list.ptr;
        let mut el = el;
    ...
    pub fn list_set_val(list: ValList, index: i32, el: Val) -> ValList {
        let mut list = list;
        list.do_not_free_on_drop();
        let list = list.ptr;
        let mut el = el;
    ...
    pub fn list_size(list: &ValList) -> i32 {
        let list = list.ptr;
    ...
    pub fn list_swap(list: ValList, pos1: u32, pos2: u32) -> ValList {
        let mut list = list;
        list.do_not_free_on_drop();
        let list = list.ptr;
