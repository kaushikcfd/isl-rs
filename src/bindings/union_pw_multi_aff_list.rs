...
use super::{Context, Error, LibISLError, UnionPwMultiAff};
use libc::uintptr_t;
use std::ffi::CStr;
...
impl UnionPwMultiAffList {
    ...
    pub fn add(self, el: UnionPwMultiAff) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
    ...
    pub fn alloc(ctx: &Context, n: i32) -> Result<UnionPwMultiAffList, LibISLError> {
    ...
    pub fn clear(self) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn concat(self, list2: UnionPwMultiAffList) -> Result<UnionPwMultiAffList, LibISLError> {
        let list1 = self;
    ...
    pub fn copy(&self) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn drop(self, first: u32, n: u32) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn free(self) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn from_union_pw_multi_aff(el: UnionPwMultiAff)
                                   -> Result<UnionPwMultiAffList, LibISLError> {
    ...
    pub fn get_at(&self, index: i32) -> Result<UnionPwMultiAff, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn get_union_pw_multi_aff(&self, index: i32) -> Result<UnionPwMultiAff, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
        let isl_rs_result =
    ...
    pub fn insert(self, pos: u32, el: UnionPwMultiAff) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn n_union_pw_multi_aff(&self) -> Result<i32, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn reverse(self) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn set_at(self, index: i32, el: UnionPwMultiAff)
                  -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
    ...
    pub fn set_union_pw_multi_aff(self, index: i32, el: UnionPwMultiAff)
                                  -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
    ...
    pub fn swap(self, pos1: u32, pos2: u32) -> Result<UnionPwMultiAffList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    /// Does not call isl_union_pw_multi_aff_list_free() on being dropped. (For
    /// internal use only.)
...
impl Drop for UnionPwMultiAffList {
    fn drop(&mut self) {
        if self.should_free_on_drop {
            unsafe {
                isl_union_pw_multi_aff_list_free(self.ptr);
            }
        }
    }
}
