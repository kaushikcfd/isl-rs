...
use super::{Context, Error, LibISLError, Set};
use libc::uintptr_t;
...
impl SetList {
    ...
    pub fn add(self, el: Set) -> Result<SetList, LibISLError> {
        let list = self;
    ...
    pub fn alloc(ctx: &Context, n: i32) -> Result<SetList, LibISLError> {
    ...
    pub fn clear(self) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn concat(self, list2: SetList) -> Result<SetList, LibISLError> {
        let list1 = self;
    ...
    pub fn copy(&self) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn drop(self, first: u32, n: u32) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn free(self) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn from_set(el: Set) -> Result<SetList, LibISLError> {
    ...
    pub fn get_at(&self, index: i32) -> Result<Set, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn get_set(&self, index: i32) -> Result<Set, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let list = list.ptr;
    ...
    pub fn insert(self, pos: u32, el: Set) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn read_from_str(ctx: &Context, str_: &str) -> Result<SetList, LibISLError> {
        let isl_rs_ctx = Context { ptr: ctx.ptr,
                                   should_free_on_drop: false };
        let ctx = ctx.ptr;
    ...
    pub fn reverse(self) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn set_at(self, index: i32, el: Set) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn set_set(self, index: i32, el: Set) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn swap(self, pos1: u32, pos2: u32) -> Result<SetList, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
    ...
    pub fn union(self) -> Result<Set, LibISLError> {
        let list = self;
        let isl_rs_ctx = list.get_ctx();
        let mut list = list;
        list.do_not_free_on_drop();
