...
impl PwAffList {
    ...
    pub fn concat(self, list2: PwAffList) -> PwAffList {
        let list1 = self;
        let mut list1 = list1;
    ...
    pub fn le_set(self, list2: PwAffList) -> Set {
        let list1 = self;
        let mut list1 = list1;
        list1.do_not_free_on_drop();
        let list1 = list1.ptr;
    ...
    /// Does not call isl_pw_aff_list_free() on being dropped. (For internal use
    /// only.)
